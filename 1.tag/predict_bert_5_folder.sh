...
for fold in {1..5}; do
    ...
    OUTPUT_DIR="${OUTPUT_BASE}/BERT_fold_${fold}_lr_${LEARNING_RATE}/predictions"
    MODEL="${OUTPUT_BASE}/BERT_fold_${fold}_lr_${LEARNING_RATE}"
    ...
    echo "Predict Fold $fold complete. File saved to $OUTPUT_DIR"
done
